...
class InvalidConfigurationException extends Exception
{
    ...
    {
        return new static(
            'BTCPay Server URL is empty. Set BTCPAY_SERVER_URL in your .env file.'
        );
    }
    ...
    {
        return new static(
            'BTCPay API Key is empty. Set BTCPAY_API_KEY in your .env file.'
        );
    }
    ...
    {
        return new static(
            'BTCPay Store ID is empty. Set BTCPAY_STORE_ID in your .env file.'
        );
    }
}
